...
let questions = [
    {
    numb: 1,
    question: "Wanner was When Marnie was there out gekomen? ",
    answer: "2014",
    options: [
      "2010",
      "2008",
...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>Je hebt <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;  //adding new span tag inside score_Text
    }
    else if(userScore > 1){ // if user scored more than 1
        let scoreTag = '<span>and Je hebt <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
